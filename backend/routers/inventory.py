...
async def get_inventory_summary(
    ...
    """Returns the latest stock levels across all tracked products and regions."""
...
async def get_low_stock_products(
    ...
    """Returns the current inventory positions below reorder point."""

    data = await db_service.get_low_stock_products(session, region_id=region_id)
    return build_response(data)
